...
<div class="container text-center w-fit p-2 space-y-2 border-2">
	<h2>Un site web, plusieurs publics</h2>
	<div class="flex flex-wrap justify-start w-fit gap-2 border-2">
		...
		{/if}-->
			<canvas use:fitToContainer bind:this={canvas} class="border-2" />
		</div>
